...
namespace ASD
{
    ...
    public class UnitMovements : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            m_RB.mass = m_Mass;
            m_RB.angularDamping = m_AngularDrag;
        ...
        private void Levitation()
        {
            ...
            float rigidbodyVelocityY = Vector3.Dot(m_RB.linearVelocity, Physics.gravity);
            ...
            if (hovering)
            {
                ...
                if (hoverError > 0)
                {
                    float upwardSpeed = m_RB.linearVelocity.y;
            ...
            if (OnGround == false) m_RB.linearDamping = 0;
            else m_RB.linearDamping = m_Drag;
        }
