...
namespace Unity.Multiplayer.Playmode.VirtualProjects.Editor
{
    ...
    class VirtualProject
    {
        ...
        bool IsCommunicative =>
            ...
            && (m_TimeSinceStartingLaunch - state.LastHeartbeatReceived).TotalSeconds <= MainEditorSystems.k_UnresponsiveTimeoutSeconds;
        ...
        public bool Launch(out LaunchProjectError errorState, out int processId, params string[] extraExternalArgs)
        {
            ...
            VirtualProjectFileRepository.ManifestRegenerateForClones(m_ParsingSystemDelegates, m_FileSystemDelegates, Identifier);
